...
public class TestTagEvent {
    ...
    void testGetTagEvent() {
        ...
        Tag result = dispatcher.getTag(metalake, tag.name());
        Event event = dummyEventListener.popPostEvent();
    ...
    void testDeleteTagEvent() {
        boolean result = dispatcher.deleteTag("metalake", tag.name());
        Event event = dummyEventListener.popPostEvent();
        Assertions.assertEquals(DeleteTagEvent.class, event.getClass());
        Assertions.assertEquals("metalake", ((DeleteTagEvent) event).metalake());
        Assertions.assertEquals(tag.name(), ((DeleteTagEvent) event).tagName());
    ...
    private TagDispatcher mockTagDispatcher() {
        ...
        when(dispatcher.alterTag(any(String.class), any(String.class), any(TagChange[].class))).thenReturn(tag);
